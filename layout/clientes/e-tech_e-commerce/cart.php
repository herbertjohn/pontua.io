...
// If the user clicked the Adicionar no carrinho button on the product page we can check for the form data
...
<?=template_header('Carrinho de Compras')?>
    ...
    <form action="index.php?page=cart" method="post">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="6" style="text-align:center;">Você não tem produtos adicionados no carrinho!</td>
                </tr>
                <?php else: ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br>
                        <a href="index.php?page=cart&remove=<?=$num?>" class="remove">Remover</a>
                    </td>
                    <td class="price">
                        <?=$product['options']?>
        ...
        <div class="buttons">
            <input type="submit" value="Limpas Carrinho" name="emptycart">
