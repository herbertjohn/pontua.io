      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>Pontúa Comunicação Digital</h3>
            <p class="font-italic">
              Trabalhamos acompanhando as tendências do mercado de marketing digital aplicando-as nos projetos dos nossos clientes.
            </p>
            <ul>
              <li><i class="icofont-check-circled"></i> Planejamento de Marketing detalhado para aprovação</li>
              <li><i class="icofont-check-circled"></i> Produção, execução/gerenciamento e assessoria.</li>
